(function(root, factory){
	...
	// source ../Regex/src/utils/exports.es6
	// source str.es6
	"use strict";
	...
	// end:source ../Regex/src/utils/exports.es6
	// source ../Regex/src/Ast/exports.es6
	// source visitor.es6
	"use strict";
	...
	//# sourceMappingURL=exports.es6.map
	// end:source ../Regex/src/Ast/exports.es6
	// source ../Regex/src/Nodes/exports.es6
	"use strict";
	...
	(function () {
		...
		(function () {
			RegexNode = class_create(Literal, {
				...
				resolveMatches: function resolveMatches(nativeMatch, matchIndex, opts) {
					var match = new Match();
				...
				compileIndexer: function compileIndexer(flags) {
	...
	//# sourceMappingURL=exports.es6.map
	// end:source ../Regex/src/Nodes/exports.es6
	// source ../Regex/src/utils/exec.es6
	"use strict";
	...
	// end:source ../Regex/src/utils/exec.es6
	// source ../Regex/src/Handlers/exports.es6
	"use strict";
	...
	(function () {
		...
		var PossessiveGroup, PossessiveLiteral;
		...
		var Initial = [[handler_GROUP, CommentGroup], [handler_GROUP, NoneCapturedGroup], [handler_GROUP, NamedGroup], [handler_GROUP, AtomicGroup], [handler_GROUP, GAnchorStatic], [handler_GROUP, LookbehindGroup], [handler_NODE, PossessiveGroup], [handler_NODE, PossessiveLiteral], [handler_LITERAL, UnicodeCodePoint], [handler_LITERAL, UnicodeCategory], [handler_LITERAL, PosixCharClass], [handler_LITERAL, CharacterTypeHandler], [handler_LITERAL, InputStart], [handler_LITERAL, InputEnd], [handler_LITERAL, InputEndWithNewLine], [handler_LITERAL, InputLastMatch]];
	
		var BeforeIndexed = [[handler_LITERAL, Subexpressions], [handler_LITERAL, NestedCharClass]];
	...
	//# sourceMappingURL=exports.es6.map
	// end:source ../Regex/src/Handlers/exports.es6

	// source ../Regex/src/Match.es6
	"use strict";
	...
	// end:source ../Regex/src/Match.es6
	// source ../Regex/src/Regex.es6
	"use strict";
	...
	// end:source ../Regex/src/Regex.es6

	// source ../src/Onig.es6
	// source OnigRegExp.es6
	"use strict";
	...
	(function () {
		...
		OnigRegExp = class_create({
			...
			search: function search(input, index, cb) {
				var arr = this.searchSync(input, index);
				cb(null, arr);
			},
			searchSync: function searchSync(input, index) {
				if (isNaN(index)) {
					index = 0;
				}
			...
			getCached: function getCached(input, index) {
			...
			addCached: function addCached(input, index, result) {
				var cache = this.cache[input];
				if (cache == null) cache = this.cache[input] = [];
			...
			test: function test(input, index, cb) {
				var matched = this.testSync(input, index);
				cb(null, matched);
			},
			testSync: function testSync(input) {
	...
	//# sourceMappingURL=OnigRegExp.es6.map
	// end:source OnigRegExp.es6
	// source OnigScanner.es6
	"use strict";
	...
	(function () {
		OnigScanner = class_create({
			regexs: null,
			constructor: function constructor(patterns) {
			...
			findNextMatch: function findNextMatch(input, index, cb) {
				var match = this.findNextMatchSync(input, index);
				cb(null, match);
			},
			findNextMatchSync: function findNextMatchSync(input) {
				var index = arguments[1] === undefined ? 0 : arguments[1];
	...
	//# sourceMappingURL=OnigScanner.es6.map
	// end:source OnigScanner.es6
	
	var Onig = {
		OnigRegExp: OnigRegExp,
		OnigScanner: OnigScanner
	};
	//# sourceMappingURL=Onig.es6.map
	// end:source ../src/Onig.es6
	return Onig;
}));